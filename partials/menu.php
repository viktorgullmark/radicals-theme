...
<header id="header">
    ...
    <div class="header">
    <!-- <div style="background-image:url(<?php the_post_thumbnail_url( 'full' );?>)" class="main-pic align-middle"> -->
        <div style="background-image:url(<?php echo $top_image ?>)" class="main-pic row">
        <!-- <h2 class="caption-text"><?php the_field('caption', $frontpage) ?></h2> -->
        <div id="header-image" class="align-self-center col-12">
            <div class="row align-items-center">
                <div class="col-md-4"></div>
                <div class="col-md-4 align-self-center">
                <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
                    <img width="200" height="169" src="https://via.placeholder.com/200x169/B4B4B4/000000"/> <!-- src="<?php the_field('logo', $frontpage) ?>" -->                    
                </a>
                </div>
